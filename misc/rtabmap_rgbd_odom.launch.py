...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('namespace',      default_value='diablo1',            description=''),
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='/camera/imu', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
